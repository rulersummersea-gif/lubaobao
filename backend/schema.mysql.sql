...
VALUES
  ...
  ('chloride', '氯离子', 5, '氯离子试纸', '≤300 mg/L', '用于判断浓缩程度和点蚀风险，氯离子过高会加剧局部腐蚀。', '偏高时优先加强排污，检查补水来源和软化/除盐设备，必要时缩短复测周期。', 1, NOW()),
...
VALUES
  ('ph', 'steam', 'boiler_water', 0, 1.0, 8.5, 10.5, '', '8.5-10.5', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('phosphate', 'steam', 'boiler_water', 0, 1.0, 10, 30, 'mg/L', '10-30 mg/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('sulfite', 'steam', 'boiler_water', 0, 1.0, 10, 30, 'mg/L', '10-30 mg/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('alkalinity', 'steam', 'boiler_water', 0, 1.0, 6, 26, 'mmol/L', '6-26 mmol/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('chloride', 'steam', 'boiler_water', 0, 1.0, NULL, 300, 'mg/L', '≤300 mg/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('hardness', 'steam', 'boiler_water', 0, 1.0, NULL, 0.03, 'mmol/L', '≤0.03 mmol/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('ph', 'steam', 'boiler_water', 1.0, 1.6, 8.5, 10.5, '', '8.5-10.5', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('phosphate', 'steam', 'boiler_water', 1.0, 1.6, 10, 30, 'mg/L', '10-30 mg/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('sulfite', 'steam', 'boiler_water', 1.0, 1.6, 10, 30, 'mg/L', '10-30 mg/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('alkalinity', 'steam', 'boiler_water', 1.0, 1.6, 6, 24, 'mmol/L', '6-24 mmol/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('chloride', 'steam', 'boiler_water', 1.0, 1.6, NULL, 300, 'mg/L', '≤300 mg/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('hardness', 'steam', 'boiler_water', 1.0, 1.6, NULL, 0.03, 'mmol/L', '≤0.03 mmol/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('ph', 'steam', 'boiler_water', 1.6, 2.5, 8.5, 10.5, '', '8.5-10.5', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('phosphate', 'steam', 'boiler_water', 1.6, 2.5, 10, 30, 'mg/L', '10-30 mg/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('sulfite', 'steam', 'boiler_water', 1.6, 2.5, 10, 30, 'mg/L', '10-30 mg/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('alkalinity', 'steam', 'boiler_water', 1.6, 2.5, 6, 16, 'mmol/L', '6-16 mmol/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('chloride', 'steam', 'boiler_water', 1.6, 2.5, NULL, 300, 'mg/L', '≤300 mg/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('hardness', 'steam', 'boiler_water', 1.6, 2.5, NULL, 0.03, 'mmol/L', '≤0.03 mmol/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('ph', 'steam', 'boiler_water', 2.5, 3.8, 8.5, 10.5, '', '8.5-10.5', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('phosphate', 'steam', 'boiler_water', 2.5, 3.8, 10, 30, 'mg/L', '10-30 mg/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('sulfite', 'steam', 'boiler_water', 2.5, 3.8, 10, 30, 'mg/L', '10-30 mg/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('alkalinity', 'steam', 'boiler_water', 2.5, 3.8, 6, 12, 'mmol/L', '6-12 mmol/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('chloride', 'steam', 'boiler_water', 2.5, 3.8, NULL, 300, 'mg/L', '≤300 mg/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW()),
  ('hardness', 'steam', 'boiler_water', 2.5, 3.8, NULL, 0.03, 'mmol/L', '≤0.03 mmol/L', 'GB/T 1576 工业锅炉水质', '工业蒸汽锅炉锅水/炉水，按压力段灰测配置；正式上线需按锅炉额定压力和现场水处理方式复核。', 1, NOW())
ON DUPLICATE KEY UPDATE
